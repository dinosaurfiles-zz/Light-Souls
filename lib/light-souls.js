function Game() {
        ...
        init: function(p) {
            ...
            this.on("hit.sprite", function(collision) {
                if (collision.obj.isA("Key")) {
                    ...
                    this.p.currentLevel++;
                    console.log(this.p.currentLevel);
                    console.log(universalPlayer.p.currentLevel);
                    // TODO: Add Scene Selection if level complete
                    if (this.p.currentLevel > 3) {
                        window.location = "";
                    } else {
                        var nextLevel = "level" + this.p.currentLevel;
    ...
    function initializeStats() {
        ...
        levelLabel.p.label = 'Level: ' + universalPlayer.p.currentLevel;
        var lifeLabel = Q("UI.Text", 1).items[1];
